...
public final class OverlayInfo implements Parcelable {
    ...
    /**
     * The OverlayInfo is enabled and cannot be disabled. This is intended to
     * keep the existing behaviour for pre-installed overlays, which previously
     * could not be disabled.
     */
    public static final int STATE_APPROVED_ALWAYS_ENABLED = 6;
     ...
     * @see #STATE_APPROVED_ALWAYS_ENABLED
     */
     ...
     */
    public OverlayInfo(@NonNull OverlayInfo source, int state, int userId) {
        this(source.packageName, source.targetPackageName, source.baseCodePath, state, userId);
    }
    ...
    private void ensureValidState() {
        ...
        switch (state) {
            ...
            case STATE_APPROVED_ALWAYS_ENABLED:
                break;
            default:
