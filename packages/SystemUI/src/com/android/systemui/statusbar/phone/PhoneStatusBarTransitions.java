...
public final class PhoneStatusBarTransitions extends BarTransitions {
    ...
    private View mLeftSide, mStatusIcons, mSignalCluster, mBattery, mClock, mIllusionLogo, mNetworkTraffic;
    ...
    public void init() {
        ...
        mIllusionLogo = mView.findViewById(R.id.illusion_logo);
    ...
    private void applyMode(int mode, boolean animate) {
        ...
        if (animate) {
            ...
            anims.playTogether(
                    ...
                    animateTransitionTo(mIllusionLogo, newAlphaBC)
                    );
            if (isLightsOut(mode)) {
            ...
            mIllusionLogo.setAlpha(newAlphaBC);
        }
    }
}
