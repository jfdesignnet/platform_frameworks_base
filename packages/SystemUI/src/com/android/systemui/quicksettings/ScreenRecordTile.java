...
public class ScreenRecordTile extends QuickSettingsTile {
    ...
    private synchronized void updateTile() {
        mDrawable = R.drawable.ic_qs_screen_recorder;
        mLabel = mContext.getString(R.string.quick_settings_screen_recorder);
    }
